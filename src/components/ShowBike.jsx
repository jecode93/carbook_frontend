...
const ShowBike = () => {
  ...
  return (
    <div className="bg-white mdp-8 flex flex-col md:flex-row items-center justify-center pt-72 lg:pt-0 w-full">
      <div className="flex flex-col flex-wrap md:flex-row gap-8 w-full items-center justify-center">
        <img
